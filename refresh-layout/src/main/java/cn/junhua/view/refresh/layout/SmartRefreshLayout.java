...
import cn.junhua.view.refresh.layout.api.DefaultRefreshFooterCreator;
import cn.junhua.view.refresh.layout.api.DefaultRefreshHeaderCreator;
import cn.junhua.view.refresh.layout.api.DefaultRefreshInitializer;
import cn.junhua.view.refresh.layout.api.RefreshContent;
import cn.junhua.view.refresh.layout.api.RefreshFooter;
import cn.junhua.view.refresh.layout.api.RefreshHeader;
import cn.junhua.view.refresh.layout.api.RefreshInternal;
import cn.junhua.view.refresh.layout.api.RefreshKernel;
import cn.junhua.view.refresh.layout.api.RefreshLayout;
import cn.junhua.view.refresh.layout.api.ScrollBoundaryDecider;
import cn.junhua.view.refresh.layout.constant.DimensionStatus;
import cn.junhua.view.refresh.layout.constant.RefreshState;
import cn.junhua.view.refresh.layout.constant.SpinnerStyle;
import cn.junhua.view.refresh.layout.footer.ClassicsFooter;
import cn.junhua.view.refresh.layout.header.ClassicsHeader;
import cn.junhua.view.refresh.layout.impl.RefreshContentWrapper;
import cn.junhua.view.refresh.layout.impl.RefreshFooterWrapper;
import cn.junhua.view.refresh.layout.impl.RefreshHeaderWrapper;
...
import cn.junhua.view.refresh.layout.listener.OnStateChangedListener;
import cn.junhua.view.refresh.layout.listener.SimpleMultiPurposeListener;
import cn.junhua.view.refresh.layout.util.SmartUtil;
...
import static cn.junhua.view.refresh.layout.util.SmartUtil.dp2px;
import static cn.junhua.view.refresh.layout.util.SmartUtil.fling;
import static cn.junhua.view.refresh.layout.util.SmartUtil.isContentView;
...
//        mManualNestedScrolling = true;
	...
	public boolean dispatchTouchEvent(MotionEvent e)
	{
		...
		{//嵌套滚动时，补充竖直方向不滚动，但是水平方向滚动，需要通知 onHorizontalDrag
