...
import cn.junhua.view.refresh.layout.listener.CoordinatorLayoutListener;
import cn.junhua.view.refresh.layout.util.DesignUtil;

import static android.view.ViewGroup.LayoutParams.MATCH_PARENT;
import static cn.junhua.view.refresh.layout.util.SmartUtil.canScrollVertically;
import static cn.junhua.view.refresh.layout.util.SmartUtil.isContentView;
import static cn.junhua.view.refresh.layout.util.SmartUtil.isTransformedTouchPointInView;
import static cn.junhua.view.refresh.layout.util.SmartUtil.measureViewHeight;
import static cn.junhua.view.refresh.layout.util.SmartUtil.scrollListBy;
